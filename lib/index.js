...
class Mecu {
    ...
    add(protein) {
        if (typeof(protein) === 'undefined' || typeof(protein.reads) === 'undefined' || protein === null || protein.reads === null || typeof(protein) !== 'object' || typeof(protein.reads) !== 'object') {
            return;
        }
        ...
        this.data = this.data.concat(protein.reads);
        ...
        for (let i = 0; i < data.length; i++) {
            ...
            this.lineSvg.append("path")
                ...
                .attr("fill", "none")
                .attr("transform", "translate(" + this.margin.left + ",0)")
                .attr("stroke", this.options.strokeColor || (this.uniprotId+"-E"+this.data[i].experiment).getHashCode().intToHSL() || "steelblue")

...
class Mecu {
    ...
    constructor(opts) {
        ...
        this.valueline = d3.line()
            .x(function (dataItem) {
                return self.x(dataItem.temp);
            })
            .y(function (dataItem) {
                return self.y(dataItem.soluble);
            })
    ...
    toggleAxes() {
        ...
        for (let i = 0; i < this.data.length; i++) {
            // Add the valueline path.
            this.lineSvg.select("#MECU"+this.data[i]._id)
